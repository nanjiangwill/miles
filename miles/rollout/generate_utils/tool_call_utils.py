...
from miles.rollout.generate_utils.score_centering import append_forced_score_centering_tokens
...
def update_sample_with_tool_responses(sample: Sample, tool_messages: list[dict[str, Any]], tokenizer):
    ...
    if sample.rollout_score_centering_head is not None:
        append_forced_score_centering_tokens(sample, next_obs_tokens_ids)
