        ...
        def add_rollout_arguments(parser):
            ...
            parser.add_argument(
                ...
                help=(
                    ...
                    "sampling-support replay and currently require --use-miles-router and a positive "
...
def miles_validate_args(args):
    ...
    if top_p_sampling_replay_enabled(args):
        ...
        # TODO(#2596): Remove this guard when the model gateway forwards
        # return_sampling_mask for chat-completions requests.
        if not args.use_miles_router:
            raise ValueError(
                "--rollout-top-p below 1 currently requires --use-miles-router; "
                "the SGLang model gateway does not forward return_sampling_mask for chat-completions requests"
            )
